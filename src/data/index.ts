 ...
 *
 * playbook.ts, defect-taxonomy.ts e agents.ts formam o núcleo conceitual: as
 * regras como estrutura de dados, a taxonomia de defeito por origem e os sete
 * agentes. O motor em `src/engine/` executa isso — não interpreta.
 *
...
export * from './types'
export * from './scope'
export { agentByName, agentNames, agents, type AgentName, type AgentSpec } from './agents'
export {
  PLAYBOOK_VERSION,
  deterministicRules,
  generativeRules,
...
export { buscarMunicipio, municipios, type Municipio } from './reference/municipios-ibge'
