...
export const playbookRules: readonly PlaybookRule[] = [
  ...
  { id: 'R-SUP-001', agent: 'VEGA', object: 'fornecedores', field: 'codigo', type: 'format',
    ...
    owner: 'Monoda · Data Engineering', playbookVersion: V1, createdAt: D, status: 'active', nature: 'deterministic' },
  ...
  { id: 'R-SUP-005', agent: 'VEGA', object: 'fornecedores', field: 'cep', type: 'format',
    ...
    owner: 'Verene · Suprimentos', playbookVersion: V1, createdAt: D, status: 'active', nature: 'deterministic' },
  { id: 'R-SUP-006', agent: 'VEGA', object: 'fornecedores', field: 'cnae', type: 'format',
    ...
    owner: 'Verene · Fiscal', playbookVersion: V1, createdAt: D, status: 'active', nature: 'deterministic' },
  ...
  { id: 'R-SUP-011', agent: 'LYRA', object: 'fornecedores', field: 'bpGrouping', type: 'domain',
    ...
    owner: 'Monoda · Arquitetura S/4HANA', playbookVersion: V1, createdAt: D, status: 'active', nature: 'deterministic' },
  ...
  { id: 'R-CTR-011', agent: 'LYRA', object: 'contratos', field: 'incoterms', type: 'domain',
    ...
    owner: 'Verene · Suprimentos', playbookVersion: V1, createdAt: D, status: 'candidate', nature: 'generative' },
  ...
  { id: 'R-SUP-033', agent: 'ATLAS', object: 'fornecedores', field: 'retencoes', type: 'survivorship',
    ...
    owner: 'Verene · Fiscal', playbookVersion: V1, createdAt: D, status: 'candidate', nature: 'generative' },
  ...
  { id: 'R-GOV-001', agent: 'KANON', object: 'transversal', field: '*', type: 'business',
    ...
    owner: 'Monoda · Governança', playbookVersion: V1, createdAt: D, status: 'active', nature: 'deterministic' },
